...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Shader batmanShader = new BitmapShader(batman, Shader.TileMode.MIRROR, Shader.TileMode.MIRROR);
        Shader batmanLogoShader = new BitmapShader(batmanLogo, Shader.TileMode.MIRROR, Shader.TileMode.MIRROR);
